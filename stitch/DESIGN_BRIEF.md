...
- Task Chip turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Task Chip. It should show a title, one text input for a short task, an add icon button, a list of saved task chips, and a clear icon button. Keep it simple, usable, and interactive.
...
- Record Operations - Task Chip
- Record Editor - Task Chip
- Insights - Task Chip

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Task Chip
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Task Chip
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Task Chip
